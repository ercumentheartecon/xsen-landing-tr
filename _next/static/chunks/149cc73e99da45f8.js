...
- bpm: processNo, name, owner, completion (0-100), steps, sla, status

addRow yaparken T\xdcM zorunlu alanları ger\xe7ek\xe7i verilerle doldur!

Kullanılabilir action'lar:
- addRow: {"type":"addRow","module":"sales","data":{"orderNo":"SO-2026-1250","customer":"Yeni M\xfcşteri A.Ş.","date":"2026-04-14","total":"₺35,000","status":"Beklemede","items":8}}
...
\xd6nce kısa T\xfcrk\xe7e a\xe7ıklama yaz, sonra gerekiyorsa action'ları ekle.`,en:`You are the XSEN ERP AI Developer assistant. You convert user requests into JSON actions.

Available modules and their REQUIRED FIELDS:
- bom: firma, tesis, uaAdi, malzeme, aciklama, durum, miktar, birim
- finance: code, name, type, balance, currency, status
- sales: orderNo, customer, date, total, status, items (number)
- production: workOrder, product, qty, completed, startDate, endDate, status, progress (0-100)
- inventory: code, name, warehouse, qty, minQty, unit, lastMove, level
- purchasing: reqNo, requester, material, qty, unit, date, status, urgency
- mrp: code, material, needed, available, planned, source, date, status
...
When using addRow, ALWAYS fill ALL required fields with realistic data!

Available actions:
- addRow: {"type":"addRow","module":"sales","data":{"orderNo":"SO-2026-1250","customer":"New Customer Inc.","date":"2026-04-14","total":"$35,000","status":"Pending","items":8}}
- deleteRow: {"type":"deleteRow","module":"bom","id":5}
- updateRow: {"type":"updateRow","module":"bom","id":3,"updates":{"miktar":100}}
...
Write a brief explanation first, then add actions only if needed.`,ru:`Ты ассистент XSEN ERP AI Developer. Ты преобразуешь запросы пользователя в JSON-действия.

Доступные модули и их ОБЯЗАТЕЛЬНЫЕ ПОЛЯ:
- bom: firma, tesis, uaAdi, malzeme, aciklama, durum, miktar, birim
- finance: code, name, type, balance, currency, status
- sales: orderNo, customer, date, total, status, items (число)
- production: workOrder, product, qty, completed, startDate, endDate, status, progress (0-100)
- inventory: code, name, warehouse, qty, minQty, unit, lastMove, level
- purchasing: reqNo, requester, material, qty, unit, date, status, urgency
- mrp: code, material, needed, available, planned, source, date, status
...
При addRow ВСЕГДА заполняй ВСЕ обязательные поля реалистичными данными!
...
Сначала краткое объяснение, затем действия при необходимости.`};function u({lang:e}){let u=n[e],{addRow:m,deleteRow:p,updateRow:y,addColumn:b,removeColumn:x,addFilter:g,bulkUpdate:h,addRelation:f,navigateTo:k,createModule:v,addMenuAction:w}=(0,s.useERPData)(),{lang:N}=(0,d.useLang)(),[R,C]=(0,a.useState)(()=>{try{let e=localStorage.getItem("xsen-dev-chat");return e?JSON.parse(e):[]}catch{return[]}}),[S,A]=(0,a.useState)(""),[j,M]=(0,a.useState)(!1),[I,O]=(0,a.useState)(()=>{try{let e=localStorage.getItem("xsen-dev-logs");return e?JSON.parse(e):[{time:new Date().toLocaleTimeString(),type:"info",message:u.welcome}]}catch{return[{time:new Date().toLocaleTimeString(),type:"info",message:u.welcome}]}});(0,a.useEffect)(()=>{try{localStorage.setItem("xsen-dev-chat",JSON.stringify(R))}catch{}},[R]),(0,a.useEffect)(()=>{try{localStorage.setItem("xsen-dev-logs",JSON.stringify(I))}catch{}},[I]);let E=(0,a.useRef)(null),T=(0,a.useRef)(null);(0,a.useEffect)(()=>{E.current?.scrollIntoView({behavior:"smooth"})},[R,j]),(0,a.useEffect)(()=>{T.current?.scrollIntoView({behavior:"smooth"})},[I]);let D=(0,a.useCallback)((e,t)=>{O(a=>[...a,{time:new Date().toLocaleTimeString(),type:e,message:t}])},[]),q=(0,a.useCallback)(e=>{let t=[],a=0;for(;;){let o="[ACTION:",l=e.indexOf(o,a);if(-1===l)break;let r=l+o.length,s=0,d=-1;for(let t=r;t<e.length;t++)if("{"===e[t])s++;else if("}"===e[t]&&0==--s){d=t+1;break}if(-1===d){a=r;continue}let i=e.slice(r,d);a=d;try{let e=JSON.parse(i),a="";switch(e.type){case"addRow":a=m(e.module,e.data||{}),D("success",a);break;case"deleteRow":a=p(e.module,e.id),D("success",a);break;case"updateRow":a=y(e.module,e.id,e.updates||{}),D("success",a);break;case"addColumn":a=b(e.module,e.column||{key:"new",label:"New"}),D("success",a);break;case"removeColumn":a=x(e.module,e.columnKey),D("success",a);break;case"addFilter":a=g(e.module,e.filter||{key:"new",label:"New"}),D("success",a);break;case"bulkUpdate":a=h(e.module,e.field,e.operation,e.value),D("success",a);break;case"addRelation":a=f(e.from,e.to,e.field,e.description||""),D("success",a);break;case"createModule":a=v(e.config),D("success",a);break;case"addMenuItem":a=w(e.moduleId,e.action),D("success",a);break;case"navigate":k(e.target),a=`Navigated to ${e.target}`,D("info",a);break;default:a=`Unknown action type: ${e.type}`,D("error",a)}t.push(a)}catch(a){let e=`Failed to parse action: ${i.slice(0,80)}...`;D("error",e),t.push(e),console.error(a)}}return t},[m,p,y,b,x,g,h,f,k,v,w,D]),L=(0,a.useCallback)(async e=>{if(!e.trim())return;let t={role:"user",content:e};C(e=>[...e,t]),A(""),M(!0),D("info",`User: ${e.slice(0,80)}${e.length>80?"...":""}`);try{let t=[{role:"system",content:c[N]},...R.map(e=>({role:e.role,content:e.content})),{role:"user",content:e}],a=await fetch("https://api.groq.com/openai/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:JSON.stringify({model:"llama-3.3-70b-versatile",messages:t,temperature:.3,max_tokens:1024})});if(!a.ok)throw Error(`Groq API error: ${a.status}`);let o=await a.json(),l=o.choices?.[0]?.message?.content||"No response",r={role:"assistant",content:l};C(e=>[...e,r]);let s=q(l);0===s.length&&D("info","AI responded (no actions)")}catch(t){let e=t instanceof Error?t.message:"Unknown error";D("error",`${u.errorPrefix}: ${e}`),C(t=>[...t,{role:"assistant",content:`${u.errorPrefix}: ${e}`}])}finally{M(!1)}},[R,N,q,D,u.errorPrefix]),P="tr"===e?[{label:n.tr.addRow,prompt:"BOM modülüne yeni bir test malzemesi satırı ekle"},{label:n.tr.addColumn,prompt:"Satış modülüne 'Kargo No' adında yeni bir kolon ekle"},{label:n.tr.addFilter,prompt:"İK modülüne departman filtresi ekle"},{label:n.tr.bulkUpdate,prompt:"Envanter modülündeki tüm miktarları %10 artır"},{label:n.tr.navigate,prompt:"BOM modülüne git"},{label:n.tr.createModule,prompt:"Müşteri şikayet takip modülü oluştur: şikayet no, müşteri adı, konu, açıklama, durum, öncelik, atanan kişi, tarih alanlarıyla"}]:"ru"===e?[{label:n.ru.addRow,prompt:"Добавить новую тестовую строку материала в модуль BOM"},{label:n.ru.addColumn,prompt:"Добавить колонку 'Номер груза' в модуль продаж"},{label:n.ru.addFilter,prompt:"Добавить фильтр по отделу в модуль HR"},{label:n.ru.bulkUpdate,prompt:"Увеличить все количества в инвентаре на 10%"},{label:n.ru.navigate,prompt:"Перейти к модулю BOM"},{label:n.ru.createModule,prompt:"Создай модуль отслеживания жалоб клиентов: номер жалобы, имя клиента, тема, описание, статус, приоритет, назначенный, дата"}]:[{label:n.en.addRow,prompt:"Add a new test material row to BOM module"},{label:n.en.addColumn,prompt:"Add a 'Cargo No' column to the sales module"},{label:n.en.addFilter,prompt:"Add a department filter to the HR module"},{label:n.en.bulkUpdate,prompt:"Increase all inventory quantities by 10%"},{label:n.en.navigate,prompt:"Navigate to BOM module"},{label:n.en.createModule,prompt:"Create a customer complaint tracking module with: complaint no, customer name, subject, description, status, priority, assignee, date fields"}];return(0,t.jsxs)("div",{className:"h-full flex flex-col bg-[#0d1117] text-gray-200 overflow-hidden",children:[(0,t.jsxs)("div",{className:"flex items-center justify-between px-4 py-2 bg-[#161b22] border-b border-[#30363d]",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsx)(r.Zap,{size:18,className:"text-green-400"}),(0,t.jsx)("span",{className:"font-semibold text-sm text-white",children:u.title})]}),(0,t.jsx)("span",{className:"text-[10px] bg-[#238636]/20 text-green-400 px-2 py-0.5 rounded-full border border-green-400/30",children:u.poweredBy})]}),(0,t.jsxs)("div",{className:"flex-1 flex overflow-hidden",children:[(0,t.jsxs)("div",{className:"w-[55%] flex flex-col border-r border-[#30363d]",children:[(0,t.jsx)("div",{className:"flex flex-wrap gap-1.5 px-3 py-2 bg-[#161b22] border-b border-[#30363d]",children:P.map(e=>(0,t.jsx)("button",{onClick:()=>L(e.prompt),disabled:j,className:"text-[10px] px-2 py-1 bg-[#21262d] hover:bg-[#30363d] text-gray-300 rounded border border-[#30363d] transition-colors disabled:opacity-50 whitespace-nowrap",children:e.label},e.label))}),(0,t.jsxs)("div",{className:"flex-1 overflow-y-auto px-3 py-2 space-y-3",children:[0===R.length&&!j&&(0,t.jsx)("div",{className:"text-center text-gray-500 text-xs mt-8",children:u.welcome}),R.map((e,a)=>(0,t.jsx)("div",{className:`flex ${"user"===e.role?"justify-end":"justify-start"}`,children:(0,t.jsx)("div",{className:`max-w-[85%] rounded-lg px-3 py-2 text-xs leading-relaxed ${"user"===e.role?"bg-[#1f6feb] text-white":"bg-[#21262d] text-gray-200 border border-[#30363d]"}`,children:(0,t.jsx)("pre",{className:"whitespace-pre-wrap font-sans",children:e.content.replace(/\[ACTION:\{.*?\}\]/g,"").trim()})})},a)),j&&(0,t.jsx)("div",{className:"flex justify-start",children:(0,t.jsx)("div",{className:"bg-[#21262d] border border-[#30363d] rounded-lg px-3 py-2 text-xs text-gray-400",children:(0,t.jsx)("span",{className:"animate-pulse",children:u.thinking})})}),(0,t.jsx)("div",{ref:E})]}),(0,t.jsx)("form",{onSubmit:e=>{e.preventDefault(),L(S)},className:"px-3 py-2 border-t border-[#30363d] bg-[#161b22]",children:(0,t.jsxs)("div",{className:"flex gap-2",children:[(0,t.jsx)("input",{type:"text",value:S,onChange:e=>A(e.target.value),placeholder:u.placeholder,disabled:j,className:"flex-1 bg-[#0d1117] border border-[#30363d] rounded px-3 py-1.5 text-xs text-gray-200 placeholder-gray-500 focus:outline-none focus:border-[#1f6feb] disabled:opacity-50"}),(0,t.jsxs)("button",{type:"submit",disabled:j||!S.trim(),className:"bg-[#238636] hover:bg-[#2ea043] disabled:opacity-50 text-white px-3 py-1.5 rounded text-xs font-medium flex items-center gap-1 transition-colors",children:[(0,t.jsx)(o.Send,{size:12}),u.send]}),(0,t.jsx)("button",{type:"button",onClick:()=>{C([]),O([{time:new Date().toLocaleTimeString(),type:"info",message:u.welcome}]);try{localStorage.removeItem("xsen-dev-chat"),localStorage.removeItem("xsen-dev-logs")}catch{}},className:"bg-[#21262d] hover:bg-[#30363d] text-gray-400 px-2 py-1.5 rounded text-xs flex items-center gap-1 transition-colors border border-[#30363d]",children:(0,t.jsx)(l.Trash2,{size:12})})]})})]}),(0,t.jsxs)("div",{className:"w-[45%] flex flex-col",children:[(0,t.jsx)("div",{className:"px-3 py-2 bg-[#161b22] border-b border-[#30363d]",children:(0,t.jsx)("span",{className:"text-xs font-medium text-gray-400",children:u.executionLog})}),(0,t.jsxs)("div",{className:"flex-1 overflow-y-auto px-3 py-2 space-y-1 font-mono text-[11px]",children:[I.map((e,a)=>{let o="success"===e.type?"text-green-400":"error"===e.type?"text-red-400":"text-yellow-400";return(0,t.jsxs)("div",{className:"flex gap-2",children:[(0,t.jsxs)("span",{className:"text-gray-600 flex-shrink-0",children:["[",e.time,"]"]}),(0,t.jsx)("span",{className:o,children:e.message})]},a)}),(0,t.jsx)("div",{ref:T})]})]})]})]})}e.s(["default",()=>u])},64937,e=>{e.n(e.i(61105))}]);